...
extension SocialFeatures {
    ...
    func twitterLogin(){
      TSGTwitterManager.twitterLogin(self)
    }
    
    func twitterLogOut(){
        
        TSGTwitterManager.twitterLogOut(self)
    }
    ...
    func publishTweet(){
        TSGTwitterManager.publishTweet(self, composeText: "just setting up my Fabric", imageName: "abc.png")
     }
    
    func getTwitterUserProfile(){
        TSGTwitterManager.getUserProfileWithScreenName("Yogesh774")
    }
